...
let interactions = [
    ...
    },
    {
        ...
        codeHighlights: {
            'index.html': "5,7,18,38"
        },
        codeComments: {
            'index.html': [
                "Line 5: Add the PeerJS Dependency",
                "Line 7: Add the VisConnect Dependency",
                "Line 18: Replace d3.drag with vc.drag",
                "Line 38: Highlight circles with the color of the collaborator to distinguish them"]
        }
    },
    {
        name: 'Brushing',
